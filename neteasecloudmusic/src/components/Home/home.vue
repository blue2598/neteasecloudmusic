      ...
      <van-tab title="排行榜" name="rankList">
        <div class="rankList">
          <div class="rank1">
            ...
            <ul>
              <li  v-for="(item,index) in ycrankList" :key="index">{{index+1}}.{{item.name}} - {{item.ar[0].name}}</li>
            </ul>
          </div>
          <div class="rank1">
            <h3>官方榜</h3>
            ...
            <ul>
              <li  v-for="(item,index) in bsrankList" :key="index">{{index+1}}.{{item.name}} - {{item.ar[0].name}}</li>
            </ul>
            <div class="picbox">
              <img :src="rgimgSrc" />
              <span class="updatedes">每天更新</span>
            ...
            <ul>
              <li  v-for="(item,index) in rgrankList" :key="index">{{index+1}}.{{item.name}} - {{item.ar[0].name}}</li>
            </ul>
            <div class="picbox">
              <img :src="xgimgSrc" />
              <span class="updatedes">每天更新</span>
            ...
            <ul>
              <li  v-for="(item,index) in xgrankList" :key="index">{{index+1}}.{{item.name}} - {{item.ar[0].name}}</li>
            </ul>
          </div>
          <div class="rank2">
            <h3>推荐榜</h3>
           <ul>
             <li>
               <p><img src="http://p2.music.126.net/y8zyTt4HwXbJqB31aQKz1A==/109951164353220919.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">云音乐说唱榜</p>
             </li>
             <li>
               <p><img src="http://p2.music.126.net/5tgOCD4jiPKBGt7znJl-2g==/18822539557941307.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">云音乐电音榜</p>
             </li>
             <li>
               <p><img src="http://p2.music.126.net/Zb8AL5xdl9-_7WIyAhRLbw==/109951164091690485.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">云音乐欧美新歌榜</p>
             </li>
             <li>
               <p><img src="http://p2.music.126.net/oUxnXXvM33OUHxxukYnUjQ==/109951164174523461.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">抖音排行榜</p>
             </li>
             <li>
               <p><img src="http://p1.music.126.net/vttjtRjL75Q4DEnjRsO8-A==/18752170813539664.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">云音乐ACG音乐榜</p>
             </li>
             <li>
               <p><img src="http://p1.music.126.net/BzSxoj6O1LQPlFceDn-LKw==/18681802069355169.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
          ...
          <div class="rank2">
           ...
           <ul>
             <li>
               <p><img src="http://p1.music.126.net/EBRqPmY8k8qyVHyF8AyjdQ==/18641120139148117.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">美国Billboard榜</p>
             </li>
             <li>
               <p><img src="http://p2.music.126.net/VQOMRRix9_omZbg4t-pVpw==/18930291695438269.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">UK排行榜 周榜</p>
             </li>
             <li>
               <p><img src="http://p1.music.126.net/A61n94BjWAb-ql4xpwpYcg==/18613632348448741.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">Beatport全球电子舞曲榜</p>
             </li>
             <li>
               <p><img src="http://p1.music.126.net/Rgqbqsf4b3gNOzZKxOMxuw==/19029247741938160.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">日本Oricon周榜</p>
             </li>
             <li>
               <p><img :src="bsimgSrc"></p>
               <span class="updatedes">每周五更新</span>
               <p class="name">iTunes榜</p>
             </li>
             <li>
               <p><img src="http://p2.music.126.net/0_6_Efe9m0D0NtghOxinUg==/109951163089272193.jpg?param=150y150"></p>
               <span class="updatedes">每周五更新</span>
